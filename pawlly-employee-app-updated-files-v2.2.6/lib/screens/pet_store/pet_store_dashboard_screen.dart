...
import 'package:pawlly_employee/screens/pet_store/pet_store_dashboard_controller.dart';
import '../../../../utils/library.dart';

class PetStoreDashboardScreen extends StatelessWidget {
  PetStoreDashboardScreen({super.key});
              ...
              onDestinationSelected: (v) {
                ...
                try {
                  if (v == 0) {
                    ...
                    homeCont.getDashboardDetail(isFromSwipeRefresh: true);
                  } else if (v == 1) {
