...
class OrderDetailController extends GetxController {
  ...
  Rx<Future<OrderDetailModel>> getOrderDetailFuture =
      Future(() => OrderDetailModel(data: OrderListData(orderDetails: OrderDetails(productDetails: ProductDetails(qty: 0.obs, productVariation: VariationData()))))).obs;
