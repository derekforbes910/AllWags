                        ...
                        AppTextField(
                          ...
                          validator: (value) {
                            if (value!.isEmpty) {
                              ...
                              return locale.value.valueMustBeGreaterThan0;
                            } else {
                              return null;
                            }
                          },
                        ...
                        AppTextField(
                          ...
                          validator: (v) {
                            if (v!.isEmpty) {
                              ...
                              return locale.value.valueMustBeGreaterThan1;
                  ...
                  AppTextField(
                    ...
                    validator: (v) {
                      if (v!.isEmpty) {
                        ...
                        return locale.value.valueMustBeGreaterThanEqual1;
                      } else if (v.contains('.') || v.startsWith('-')) {
                        return locale.value.theInputtedStockIsInvalid;
                      } else {
                        return null;
          ...
          children: [
            ...
            Obx(
              () => AppTextField(
                ...
                isValidationRequired: addShopController.isDiscountAmount.value,
                decoration: inputDecoration(
                  ctx,
                ...
                onChanged: (p0) {
                  if (p0.isNotEmpty) {
                    ...
                    if (intValue != null && p0.length <= 3 && intValue >= 1 && intValue <= 100) {
                      addShopController.isDiscountAmount(true);
                    } else {
                      addShopController.isDiscountAmount(false);
                      addShopController.discountAmountCont.text = '0';
                      addShopController.discountAmountCont.selection = TextSelection.fromPosition(
                        TextPosition(offset: addShopController.discountAmountCont.text.length),
                      );
                    }
                  } else {
                    addShopController.isDiscountAmount(false);
                ...
                validator: (p0) {
                  ...
                  if (p0 != null && p0.length > 3) {
                    // return locale.value.inputTooLong;  // Adjust this message as needed
                  } else if (intValue == null || intValue < 1 || intValue > 100) {

                  } else if (addShopController.isDiscountAmount.value && addShopController.dateRangeCont.text.isEmpty) {
                    return locale.value.pleaseSelectADate;
                  } else if (addShopController.selectedDiscountType.value.productDiscountType == ProductDiscountTypes.PERCENT && intValue >= 100) {
                    ...
                    if (addShopController.isHasVariation.value) {
                      bool isValidDiscount = addShopController.variationCombinationList.any((element) => intValue >= element.priceCont.text.toDouble());
                      if (isValidDiscount) {
                        return locale.value.fixedDiscountValueMust;
                      } else {
                        return null;
                      }
                    } else if (!addShopController.isHasVariation.value && intValue >= addShopController.priceCont.text.toDouble()) {
                      return locale.value.fixedDiscountValueMust;
                    } else {
                      return null;
                    }
        ...
        children: [
                    ...
                    Row(
                      ...
                      children: [
                        if (!addShopController.isLoading.value) ...[
                          if (addShopController.tagsList.isNotEmpty) selectTags(context).expand(),
                          if (addShopController.tagsList.isNotEmpty && addShopController.unitsList.isNotEmpty) 16.width,
                          if (addShopController.unitsList.isNotEmpty) selectUnit(context).expand(),
                        ],
                      ],
                    ),
                    30.height,
          ...
          Positioned(
            ...
            child: AppButton(
              ...
              onTap: () {
                if (!addShopController.isLoading.value) {
                  if (addShopController.priceCont.text.startsWith('.') || addShopController.priceCont.text.startsWith('-')) {
                    toast(locale.value.theInputtedPriceIsInvalid);
                  } else if (addShopController.discountAmountCont.text.contains('.') || addShopController.discountAmountCont.text.startsWith('-')) {
