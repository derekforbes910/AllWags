          ...
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Image.asset(
                    Assets.authImagesSignin, //isDarkMode.value ? Assets.imagesLogoDark : Assets.imagesLogo,
                  ...
                  if (appConfigs.value.googleLoginStatus == 1 && isAndroid || (isApple && appConfigs.value.googleLoginStatus == 1 || isApple && appConfigs.value.appleLoginStatus == 1))
                    Row(
                      children: [
                        Container(
