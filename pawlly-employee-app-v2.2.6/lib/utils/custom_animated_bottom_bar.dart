              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(item.titleText,
                      maxLines: 1, textAlign: item.textAlign, style: primaryTextStyle(color: isSelected ? item.activeColor.withOpacity(1) : item.inactiveColor ?? item.activeColor, size: 14)),
                ),
                const Spacer(),
              ],
            ),
