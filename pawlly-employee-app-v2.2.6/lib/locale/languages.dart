...
abstract class BaseLanguage {
  ...
  String get theInputDurationIsInvalid;

  String get valueMustBeGreater;

  String get manageShopProducts;

  String get manageOrders;

  String get manageShopBrands;

  String get manageShopUnits;

  String get manageShopTags;
  ...
  String get doYouWantToProductProcess;

  String get haveYouDeliveredThe;
  ...
  String get valueMustBeGreaterThan0;

  String get valueMustBeGreaterThan1;

  String get valueMustBeGreaterThanEqual1;

  String get pleaseSelectADate;

  String get fixedDiscountValueMust;
  ...
  String get oneDayPrice;

  String get serviceManagement;

  String get facilityList;

  String get manageYourFacilities;

  String get durationList;

  String get manageYourDurations;

  String get trainingServiceList;

  String get manageTrainingServices;

  String get bookingConfiguration;
  ...
  String get myDurations;

  String get oppsThereAreCurrentlyNoDurationsAvailable;

  String get oppsLooksLikeYouHaveNotAddedAnyDurationYet;

  String get addNewDuration;

  String get areYouSureYouWantToDeleteThisDuration;

  String get editServiceFacility;

  String get addServiceFacility;

  String get facilityName;

  String get enterFacilityDescription;

  String get serviceFacility;

  String get myFacilities;

  String get oppsThereAreCurrentlyNoFacilitiesAvailable;

  String get oppsLooksLikeYouHaveNotAddedAnyFacilityYet;

  String get addNewFacility;

  String get areYouSureYouWantToDeleteThisFacility;

  String get totalFacilities;

  String get totalTrainingServices;

  String get totalDurations;

  String get editTrainingService;

  String get addTrainingService;

  String get trainingTypeName;

  String get enterServiceDescription;

  String get youCanNotAddSameDataForDurationsPleaseUpdateT;

  String get trainingServices;

  String get myTrainingTypes;

  String get oppsThereAreCurrentlyNoTrainingTypesAvailable;

  String get oppsLooksLikeYouHaveNotAddedAnyTrainingTypeYe;

  String get addNewTrainingService;

  String get viewDetail;

  String get areYouSureYouWantToDeleteIt;

  String get durationsAndPrice;

  String get pickTimeDuration;

  String get petSitter;

  String get petStore;

  String get enterTheAmountForOneDayBoardingService;

  String get enterTheAmountForOneDayDaycareService;
